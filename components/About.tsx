export default function About() {
  const skills = [
    ...
    { name: "Micro Front End", category: "Architecture", icon: "🧩" },
    { name: "Mono Repo", category: "Architecture", icon: "📦" },
    ...
    { name: "Bootstrap 3", category: "Styling", icon: "🟣" },
    { name: "LLM", category: "AI/ML", icon: "🧠" },
    { name: "AI", category: "AI/ML", icon: "🤖" },
    { name: "Co-Pilot", category: "AI/ML", icon: "🚁" },
