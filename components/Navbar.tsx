      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-20">
          ...
          <div className="hidden md:flex items-center space-x-4">
            <button className="p-2 rounded-xl bg-white/10 dark:bg-neutral-800/30 hover:bg-white/20 dark:hover:bg-neutral-700/40 transition-all duration-300 backdrop-blur-sm border border-white/20 dark:border-neutral-700/50">
              <svg
